...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='Ezqa1nPZ18kRKcPsI1Dc.dP9jwNnpN82C9ikgCsDSVa.i2S+BcS2x0/OIFtCz0rvoJDR1E3SqcR8qam4phGBj48=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EzNxJbtPxwN3EZ93bs39.FcuMrOXqhOS3oyxH8r2Bsq.8cdxZU+N4wgz2Q4M/JX09Avuk+bUccJYC45gMOsA/Mo=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EzsSbZa6eimdydUKWMQ9.WpHyQNDLkGiSMBNPP2Y3Mq.eG3YLASQ4DhuwukcCy5k1Spm56bWfmKaWqDodjHl314=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EzInyocVBPIaNTV9nXu4.mqKc2MNKlpicxDXNF/VJPa.gc4yfkZUR9OXJ+2OeslXAbYryzhtHxj60WQ71gt5rRs=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EzyMmwj9BaHpKoo3vOrc.Im1Fns29f02oCQn+BIwX7a.P/iE6+MGQferoUXMvUodDL2jup4BpD9wubmmTF+gVo8=')
...
wait = {
    ...
    "Respontag":"࿆࿇࿆࿐࿆※🌛 Tag Usah lah Nge tag\nPnting di VC Aja\nLagian aq masih Pipis ini] ☀🌜͍※࿑༆࿆࿇ ",
    "welcome":"Selamat datang & semoga betah",
    "comment":"Like like & like by ✪ᎢᎬᎪᎷ в❍тs JhᎪiL✪",
    "message":"Terimakasih sudah add saya ? bots Oa = https://line.me/R/ti/p/%40aum8249uJhail = https://line.me/R/ti/p/~jhail...idGirl Jhail  = https://line.me/R/ti/p/~endell_22?",
    }
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator   ◄]·✪ ᎢᎬᎪᎷ в❍тs JhᎪiL ✪·[►") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   cl.sendText(msg.to,"Done, mantan berhasil di buang ke laut...")
                               except:
                                   pass
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, " ◄]·✪ ᎢᎬᎪᎷ в❍тs JhᎪiL ✪·[► Grup Info\n\n]►Nama Group : {}".format(G.name)+ "\n]►ID Group : {}".format(G.id)+ "\n]►Pembuat : {}".format(G.creator.displayName)+ "\n]►Waktu Dibuat : {}".format(str(timeCreated))+ "\n]►Jumlah Member : {}".format(str(len(G.members)))+ "\n]►Jumlah Pending : {}".format(gPending)+ "\n]►Group Qr : {}".format(gQr)+ "\n]►Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += " ◄]·✪ ᎢᎬᎪᎷ в❍тs JhᎪiL ✪·[► Grup Info\n"
                                ret_ += "\n]►Nama Group : {}".format(G.name)
                                ret_ += "\n]►ID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"]►bots JhaiL\n\n"+ma+"\n]►Total「%s」 ]►Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "Daa.... aq pulang dulu ya..., jangan lupa klo aq datang lagi, kasih yang enak-enak ya,"+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "Menghitung hutang...")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "{} detik per jam juga tidak lupa cari tikungan ".format(str(elapsed_time)))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "]►Cek Cok diaktifkan\n\n]►Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n]►Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "]►Cek Cok dinonaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
...
#===========ADMIN ADD============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"Berhasil menambahkan Mimin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Dpk:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"Berhasil menghapus Mimin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Sudah di sapu dan di pel ...")
